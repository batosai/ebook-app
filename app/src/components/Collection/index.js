...
class Collection extends Component {
  ...
  render() {
    return (
      <Dropzone onDrop={this.onDrop} multiple={false} disableClick accept={"application/pdf"} onDragEnter={this.onDragEnter} onDragLeave={this.onDragLeave} style={this.state.dropzone} >
        <Tiles
          style={style}
