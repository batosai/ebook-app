  ...
  render = () => {
    ...
    return (
      <Dialog
        ...
        >
          <div style={this.state.tabIndex ? {'display': 'none'} : {'display': 'block'}}>
            <TextField
          ...
          <div style={this.state.tabIndex ? {'display': 'block'} : {'display': 'none'}}>
            <Dropzone onDrop={this.onDrop} multiple={false} accept={"image/jpeg, image/png"} onDragEnter={this.onDragEnter} onDragLeave={this.onDragLeave} style={this.state.dropzone} >
